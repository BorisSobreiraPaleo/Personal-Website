...
import enWorkData from "../../assets/data/work/enWorkData"
import esWorkData from "../../assets/data/work/esWorkData"
import useLanguage from "../../languageContext/useLanguage"

const Work = () => {
  const { language } = useLanguage()
  
  const data = language === 'en' ? enWorkData : esWorkData
  const invertedData = [...data].reverse()
  
  return (
    <section id="work" className="dark:bg-[#000B11]">
